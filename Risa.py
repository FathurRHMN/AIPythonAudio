...
def greetMe():
    ...
    if currentH >=0 and currentH <12:
        print("Selamat Pagi Fathur")
    if currentH >=12 and currentH <18:
        print("Selamat Siang Fathur")
    if currentH >=18 and currentH <0:
        print("Selamat Malam Fathur")
...
def assistant(command):
    ...
    if 'hello bro' in command:
        print('Bejo : Hello Fathur, How can I help you?')
        ...
        if reg_ex:
            ...
            print('Bejo : Bye Fathur. Happy to help you. Have a good day.')
            exit()
